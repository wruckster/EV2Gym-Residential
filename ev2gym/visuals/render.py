...
def get_icon_path(icon_name):
    """Helper function to get icon path using importlib.resources"""
    with importlib.resources.path('ev2gym.visuals.icons', icon_name) as p:
        return str(p)

# Image paths for graph nodes
icons = {
    "cpo": get_icon_path("cpo.png"),
    "transformer": get_icon_path("transformer.png"),
    "charger_1": get_icon_path("charging-station_1_port.png"),
    "charger_2": get_icon_path("charging-station_2_ports.png"),
    "charger_wallbox": get_icon_path("charger_wallbox.png"),
    "ev": get_icon_path("ev.png")
}
